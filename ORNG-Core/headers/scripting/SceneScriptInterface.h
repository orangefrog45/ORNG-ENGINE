...
namespace ScriptInterface {
	namespace World {
		...
		inline static std::function<ORNG::OverlapQueryResults(glm::vec3 origin, float range)> OverlapQuery = nullptr;
		inline static std::function<ORNG::SceneEntity& (entt::entity entity_uuid)> GetEntityEnttHandle = nullptr;
	}
}
#endif